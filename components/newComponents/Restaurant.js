...
const Restaurant = ({
  ...
  <TouchableOpacity style={[styles.container, { ...myStyle }]} onPress={evnt}>
    <View style={styles.topCont}>
      <View style={styles.imageCont}>
        <Image source={{ uri: img }} style={styles.aspectrat} />
      </View>
      <View style={styles.nameCont}>
        <Text
          style={[
            styles.name,
            active === number ? { color: colors.a } : { color: colors.c }
          ]}
        >
          {name}
        </Text>
    ...
    <View style={styles.cuisineInfo}>
      <Text
        style={[
          ...
          styles.distance,
          active === number
            ? { color: colors.a, borderColor: colors.a }
