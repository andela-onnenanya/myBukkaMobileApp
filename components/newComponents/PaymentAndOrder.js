          ...
          >
            <View style={myStyles.conta}>
              ...
              {this.state.cart && this.state.payment && this.state.order ? (
                ...
                <Icon name="circle" size={25} color={"rgba(0,0,0,.2)"} />
              )}
            ...
            <View
              style={[
                myStyles.tabnameCont,
                { marginLeft: -10, marginRight: -10, marginTop: 30 }
              ]}
            >
              <Text
                style={[
                  myStyles.textCheckout,
                  this.state.actve === "cart"
                    ? { color: colors.a }
                    : { color: "rgba(0,0,0,.5)" }
                ]}
              >
