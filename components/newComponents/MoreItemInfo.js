    ...
    return (
      <View style={[styles.containerk,myStyle.parentCont]}>
            <View style={[styles.containerl,myStyle.buttonCont]}>
              ...
              <SocialShare  message = {'10 pieces of buffalo chicken wing and Fries with a can drink'}
                            title = {foodName + 'on Bukka'}
                            url = {'https://goo.gl/D4W4MV'}/>
            </View>
            <View style={[styles.all_width,styles.all_height]}>
              ...
              <View style={[styles.flexc,styles.topa]}>
                <View style={[styles.flexc,styles.flexd,myStyle.moreInfo,(this.state.typing)?{display:'none'}:{display:'flex'}]}>
                  <View  style={[styles.topb]}>
                    <BoldText deco={[styles.texte,myStyle.foodNameText]} text={foodName} />
                    <BoldText deco={[styles.textf,myStyle.cuisineCont]} text={'\u2022'+ cuisine} />
                  </View>
                  <View style={myStyle.detailsCont}>
                    <Text style={myStyle.detailsText} numberOfLines={3} >{'10 pieces of buffalo chicken wing and Fries with a can drink'}</Text>
                    <Text style={myStyle.etd}>{'Expected time of delivery is 3 hour 10 mins'}</Text>
                  </View>
                </View>
                <View>
                ...
                <View style={[styles.containerm]}>
                   <View style={myStyle.specialIns} >
                    ...
                    <TextInput  style={[styles.textInputa,myStyle.myText]} 
                  ...
                  <View style={myStyle.addbuttonCont}>
                    <View  style={styles.containern}>
                        ...
                        <Text style={[styles.textd,myStyle.myText]}>{this.state.quantity}</Text>
                        <TouchableOpacity  style={myStyle.touchadd} onPress={this.subtract}>
