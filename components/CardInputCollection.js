  ...
  <ScrollView style={{ flex: 1 }}>
    ...
    >
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        <Img source={{ uri: rsc.NIGflag }} style={{ width: 21, height: 13 }} />
      </View>

      <TextInput style={{ flex: 5 }} value={"Nigeria"} editable={false} />
    </View>
    <View
      style={{
        borderWidth: 2,
    ...
    <View style={{ flexDirection: "row", marginBottom: 10 }}>
      ...
      >
        ...
        >
          <Icon name="date-range" size={24} color={"#C4C4C4"} />
        </View>
        <TextInput
          style={{ flex: 5 }}
      ...
      >
        <View
          style={{ flex: 1, justifyContent: "center", alignItems: "center" }}
        >
          <Icon name="credit-card" size={24} color={"#C4C4C4"} />
        </View>
        <TextInput
          style={{ flex: 5 }}
          placeholder="CVV"
